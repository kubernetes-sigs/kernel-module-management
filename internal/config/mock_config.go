...
func (m *MockConfigGetter) GetConfig(ctx context.Context, userConfigMapName, userConfigMapNamespace string) (*Config, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConfig", ctx, userConfigMapName, userConfigMapNamespace)
	ret0, _ := ret[0].(*Config)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockConfigGetterMockRecorder) GetConfig(ctx, userConfigMapName, userConfigMapNamespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetConfig", reflect.TypeOf((*MockConfigGetter)(nil).GetConfig), ctx, userConfigMapName, userConfigMapNamespace)
}
...
func (m *MockconfigHelperAPI) newDefaultConfig() *Config {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "newDefaultConfig")
	ret0, _ := ret[0].(*Config)
	return ret0
}

// newDefaultConfig indicates an expected call of newDefaultConfig.
func (mr *MockconfigHelperAPIMockRecorder) newDefaultConfig() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "newDefaultConfig", reflect.TypeOf((*MockconfigHelperAPI)(nil).newDefaultConfig))
}
