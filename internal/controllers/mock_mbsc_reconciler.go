...
// updateStatusByBuilds mocks base method.
func (m *MockmbscReconcilerHelperAPI) updateStatusByBuilds(ctx context.Context, mbscObj *v1beta1.ModuleBuildSignConfig) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "updateStatusByBuilds", ctx, mbscObj)
	ret0, _ := ret[0].(error)
	return ret0
}

// updateStatusByBuilds indicates an expected call of updateStatusByBuilds.
func (mr *MockmbscReconcilerHelperAPIMockRecorder) updateStatusByBuilds(ctx, mbscObj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "updateStatusByBuilds", reflect.TypeOf((*MockmbscReconcilerHelperAPI)(nil).updateStatusByBuilds), ctx, mbscObj)
}
