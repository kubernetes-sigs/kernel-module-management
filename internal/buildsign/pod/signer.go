...
func NewSigner(
	client client.Client,
	scheme *runtime.Scheme,
	buildSignPodManager buildsignpod.BuildSignPodManager) Signer {
	return &signer{
		client:              client,
		scheme:              scheme,
...
func (s *signer) MakePodTemplate(
	...
	pod := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels:       s.buildSignPodManager.PodLabels(mld.Name, mld.KernelNormalizedVersion, buildsignpod.PodTypeSign),
