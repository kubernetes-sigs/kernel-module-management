...
//go:generate mockgen -source=creator.go -package=api -destination=mock_creator.go ModuleLoaderDataCreator,moduleLoaderDataCreatorHelper

type ModuleLoaderDataCreator interface {
	FromModule(mod *kmmv1beta1.Module, kernelVersion string) (*ModuleLoaderData, error)
}

type moduleLoaderDataCreator struct {
	helper moduleLoaderDataCreatorHelper
}

func NewModuleLoaderDataCreator() ModuleLoaderDataCreator {
	return &moduleLoaderDataCreator{
		helper: &moduleLoaderDataCreatorHelperImpl{
			sectionGetter: &sectionGetterImpl{},
		},
	}
}

func (f *moduleLoaderDataCreator) FromModule(mod *kmmv1beta1.Module, kernelVersion string) (*ModuleLoaderData, error) {
...
type moduleLoaderDataCreatorHelper interface {
...
type moduleLoaderDataCreatorHelperImpl struct {
	sectionGetter sectionGetter
}

func (kh *moduleLoaderDataCreatorHelperImpl) findKernelMapping(mappings []kmmv1beta1.KernelMapping, kernelVersion string) (*kmmv1beta1.KernelMapping, error) {
...
func (kh *moduleLoaderDataCreatorHelperImpl) prepareModuleLoaderData(mapping *kmmv1beta1.KernelMapping, mod *kmmv1beta1.Module, kernelVersion string) (*ModuleLoaderData, error) {
	var err error
...
func (kh *moduleLoaderDataCreatorHelperImpl) replaceTemplates(mld *ModuleLoaderData) error {
