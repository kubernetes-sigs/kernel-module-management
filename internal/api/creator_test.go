...
var _ = Describe("moduleLoaderDataCreatorHelper_findKernelMapping", func() {
	const kernelVersion = "1.2.3"

	var (
		ctrl  *gomock.Controller
		mldfh moduleLoaderDataCreatorHelper
	)

	BeforeEach(func() {
		ctrl = gomock.NewController(GinkgoT())
		mldfh = &moduleLoaderDataCreatorHelperImpl{
...
var _ = Describe("moduleLoaderDataCreatorHelper_prepareModuleLoaderData", func() {
	const kernelVersion = "1.2.3"
	...
	BeforeEach(func() {
		...
		mldfh = &moduleLoaderDataCreatorHelperImpl{sectionGetter: sg}
		mod = kmmv1beta1.Module{}
...
var _ = Describe("moduleLoaderDataCreatorHelper_replaceTemplates", func() {
	const kernelVersion = "5.8.18-100.fc31.x86_64"

	mdlfh := moduleLoaderDataCreatorHelperImpl{}
