...
//
//	mockgen -source=podhelper.go -package=utils -destination=mock_podhelper.go
//
...
func (mr *MockPodHelperMockRecorder) CreatePod(ctx, podSpec any) *gomock.Call {
...
func (mr *MockPodHelperMockRecorder) DeletePod(ctx, pod any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPodHelperMockRecorder) GetModulePodByKernel(ctx, modName, namespace, targetKernel, podType, owner any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPodHelperMockRecorder) GetModulePods(ctx, modName, namespace, podType, owner any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPodHelperMockRecorder) GetPodStatus(pod any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPodHelperMockRecorder) IsPodChanged(existingPod, newPod any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPodHelperMockRecorder) PodLabels(modName, targetKernel, podType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
