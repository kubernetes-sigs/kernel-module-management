...
func (m *MockJobHelper) GetModuleJobByKernel(ctx context.Context, modName, namespace, targetKernel string, jobType JobType, owner v10.Object) (*v1.Job, error) {
	m.ctrl.T.Helper()
...
func (m *MockJobHelper) GetModuleJobs(ctx context.Context, modName, namespace string, jobType JobType, owner v10.Object) ([]v1.Job, error) {
	m.ctrl.T.Helper()
...
func (m *MockJobHelper) JobLabels(modName, targetKernel string, jobType JobType) map[string]string {
	m.ctrl.T.Helper()
