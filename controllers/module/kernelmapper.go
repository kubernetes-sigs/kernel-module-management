...
type KernelMapper interface {
	FindMappingForKernel(mappings []ootov1beta1.KernelMapping, kernelVersion string) (*ootov1beta1.KernelMapping, error)
}
...
func (kernelMapper) FindMappingForKernel(mappings []ootov1beta1.KernelMapping, kernelVersion string) (*ootov1beta1.KernelMapping, error) {
